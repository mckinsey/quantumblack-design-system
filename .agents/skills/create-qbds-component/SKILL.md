...
Doc hierarchy: [props.md](../../../docs/qbds-react-components/props.md) + [composition.md](../../../docs/qbds-react-components/composition.md) define the public API; [build.md](../../../docs/qbds-react-components/build.md) implements it; [demos.md](../../../docs/qbds-react-components/demos.md) showcases it.
