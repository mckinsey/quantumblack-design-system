...
Doc hierarchy: [react-components/props.md](../../../docs/react-components/props.md) + [react-components/composition.md](../../../docs/react-components/composition.md) define the portable API step; [props.md](../../../docs/qbds-react-components/props.md) + [composition.md](../../../docs/qbds-react-components/composition.md) add QBDS rules; [build.md](../../../docs/qbds-react-components/build.md) implements it; [demos.md](../../../docs/qbds-react-components/demos.md) showcases it.
...
| `api`          | [react-components/props.md](../../../docs/react-components/props.md) + [react-components/composition.md](../../../docs/react-components/composition.md) + [props.md](../../../docs/qbds-react-components/props.md) + [composition.md](../../../docs/qbds-react-components/composition.md) |
| `api_gate`     | Before `build`: output export list (one-line purpose each) + demo plan (`examples[]` names and what each proves). Stop if exports exceed shadcn baseline + QBDS axes from the alignment table, or if the demo plan splits axis values or `show*` toggles into separate examples.          |
