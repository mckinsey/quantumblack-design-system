...
- **`pr-preview.yml`** — on pull requests, builds and deploys a registry preview to GitHub Pages and comments the URL on the PR (also under the **Pages Preview** check). Same Pages setup as production; not for fork PRs.
